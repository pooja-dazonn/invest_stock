...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="adminindex" class="logo"><b>DASH<span>IO</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="home" target="_blank">Home</a></li>
        </ul>&nbsp;&nbsp;
        <ul class="nav pull-right top-menu">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="menu-item-has-children dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Stock</a>
            <ul class="sub-menu children dropdown-menu">
              <li><a href="adminstock"><i class="fa fa-desktop"></i>Add Stock</a></li>
              <li><a href="tabledit"><i class="fa fa-users"></i>All Stock</a></li>
            </ul>
          </li>
