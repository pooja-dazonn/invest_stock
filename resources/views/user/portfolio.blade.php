                ...
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                                <h1 class="margin-b-0 home-h1" style="color: #bd5434">The MILARS way!</h1>
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    @csrf
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="category" type="text" id="category" value="MillarsPortfolio" placeholder="MillarsPortfolio" readonly>
                                 <span style="color:red">@error('catogory'){{ $message }} @enderror</span>
                              </fieldset>
                            </div>
...
<section class="table">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title" style="text-align:center">Millars Portfolio Information </h3>
              </div>
