                ...
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                               <h1 class="margin-b-0 home-h1" style="color: #bd5434">Stocks on The Move</h1>
            </div>
                ...
                <div class="col-lg-6">
                    ...
                    @csrf
                          <div class="row">
                           ...
                           <div class="col-lg-6 col-sm-12">
                  <fieldset>
                    <input name="category" type="text" value="StockMove" id="category" placeholder="StockMove" readonly>
